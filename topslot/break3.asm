...
install:
	LDX	#olitm		;Copy menu item to buffer ready to insert in menu
        JSR     insitm
	LDX     #ilitm
	JSR     insitm
	LDX     #opitm
...
insitm:	
	...
	RTS
remove:
	ldaa ^Xffe9		;ROM version
	cmpa #^X22
	bhi	1$              ; Check version against v2.2
...
outpico:
	...
	CLR     POB_DDR2                ; make port 2 inputs again
        ...
        OIM     #^CCS3,POB_PORT6      ; SELECT THE SLOT AGAIN
